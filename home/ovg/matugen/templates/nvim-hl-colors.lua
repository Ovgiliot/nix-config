-- Generated by matugen — do not edit. Source: nvim-hl-colors.lua template.

-- Headline background bars (container roles — distinct hue tints in dark scheme)
...
vim.api.nvim_set_hl(0, "Headline5", { bg = "{{colors.surface_container.default.hex}}" })
vim.api.nvim_set_hl(0, "Headline6", { bg = "{{colors.surface_container_high.default.hex}}" })

-- Per-level headline text colors
...
vim.api.nvim_set_hl(0, "@org.hyperlink.url",  { fg = "{{colors.on_primary_container.default.hex}}", underline = true })
